/*=============================================================================
Created by Long Dương (huulongduong@gmail.com), 2017. License: No License :)
=============================================================================*/
...
Vue.component('vue-submit',
    {
        ...
        computed:
        {
            ...
            bar_style: function () {
                return {
                    position: 'absolute', top: 0, left: 0, bottom: 0, backgroundColor: '#fff', transition: 'width 200ms linear', opacity: '0.4',
            ...
            spn_style: function () {
                return {
                    position: 'relative', border: '3.5px solid rgba(255,255,255,0.5)', borderRightColor: '#fff', borderRadius: '50%', display: 'inline-block',
                    width: '1.33em', height: '1.33em', zIndex: 2, marginLeft: '6px', verticalAlign: 'text-top', top: '-1px',
                    animation: 'spin 0.75s linear', animationIterationCount: 'infinite',
